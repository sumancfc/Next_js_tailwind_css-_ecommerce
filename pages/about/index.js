                    ...
                    <div className="max-w-md mx-auto sm:max-w-xl lg:pr-12  lg:max-w-full  2xl:col-span-3">
                        <div className="xl:max-w-xl">
                            ...
                            <p className="mt-2 text-gray-600 sm:mt-4 sm:text-xl">
                                Bhotahiti.com is an eCommerce platform that connects buyers and
                                sellers with ease. We exist to enable economic opportunity for
                                individuals, entrepreneurs, businesses, and directories of all
                                sizes. Bhotahiti.com is an online wholesale marketplace for all
                                products that are focused on selling products to the small retail
                                sellers directly from the producers.
                            </p>
                            <p className="mt-2 text-gray-600 sm:mt-4 sm:text-xl">
                                It will cater to the need of small, medium, or any sized businesses.
                                ...
                                Buyers, who shop on our Marketplace and Classifieds platforms, enjoy
                                a highly personalized experience with an unparalleled selection at a
                                great value.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="py-12 md:py-20">
                            ...
                            <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-3 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-4xl">
                                {datas.map((data) => (
                                    ...
                                    >
                                        <i
                                            className={`${data.icon} text-4xl text-main-blue mb-1`}
                                        ></i>
